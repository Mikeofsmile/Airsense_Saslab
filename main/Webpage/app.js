 ...
 */
function getDataSensorValues()
{
	$.getJSON('/dataSensor.json', function(data) {
		$("#temperature_obj").text(data["temp_obj"]);
		$("#temperature_ambient").text(data["temp_ambient"]);
	});
}
 ...
 */
function startDataSensorInterval()
{
	setInterval(getDataSensorValues, 5000);
}
